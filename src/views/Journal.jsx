...
function Journal() {
  ...
  const data = [
    ...
    },
    {
      ...
      name: 'GA House Exhibition',
      date: 'March - May 2014',
      img_url:'https://res.cloudinary.com/dm9ufmxnq/image/upload/v1661264579/297174769_1263499707745193_2731266844231810095_n_jv61rp.jpg',
        ...
        <div className="left" >
          {
            left.map(({name, date, img_url, desc, id}, i)=>(
              <div onClick={_ => handleClick(id)} key={i} className='cursor-pointer bubble' style={{ display: 'cell' }} >
